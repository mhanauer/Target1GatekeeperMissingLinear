...
library(lsr)
cohensD(datTimeTreat[[1]]$Sec2Total, datTimeTreat[[1]]$Time)
compmeans(datTimeTreat[[1]]$Sec2Total, datTimeTreat[[1]]$Time)
...
test= compmeans(datAllTimeT2[[1]]$Sec2Total, datAllTimeT2[[1]]$Time)
test
```
#########################
T3 Only Sec2PrePost
